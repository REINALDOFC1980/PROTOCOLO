...
namespace CondutorInfrator.Controllers.CNPJ
{
    public class Juridico_DefesaAutuacaoController : Controller
    {
        ...
        public Juridico_DefesaAutuacaoController()
        {
               ...
               // funcao.CriarPasta(pathTemp);
                ...
                for (int i = 0; i < files.Count; i++)
                {
                    ...
                    if (file.ContentType == "application/pdf")
                    {
                        ...
                        if (retorno == 0)
                            return Json(new { formatoimg = false, imagemerro = Nome }, JsonRequestBehavior.AllowGet);
                ...
                return Json(new { redirectUrl = Url.Action("VisualizarAnexo", "Juridico_Defesaautuacao"), isRedirect = true, pro_numero, formatoimg = true, imagemerro = "", Restricao = Restricao_Final }, JsonRequestBehavior.AllowGet);
        ...
        [HttpPost]
        public JsonResult RealizarAbertura(string pro_numero, string Restricao, string Mut_AIT)
        {
            //ação API 
