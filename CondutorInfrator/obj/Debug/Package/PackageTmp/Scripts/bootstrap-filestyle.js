...
(function($) {
	...
	Filestyle.prototype = {
		...
		htmlInput : function() {
			if (this.options.input) {
				return '<input type="text" class="form-control ' + (this.options.size == 'nr' ? '' : 'input-' + this.options.size) + '" placeholder="'+ this.options.placeholder +'" disabled style="margin-top:0px;border: 1px solid rgba(0,0,0,0); height: 45px;"> ';
			} else {
				return '';
			}
		},
